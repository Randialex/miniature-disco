...
import TodayChamber from "@/components/TodayChamber";
...
export default function HomePage() {
  ...
  return <div className="home-page">
    ...
    <TodayChamber />
    <Link href="/owl-post" className="home-owl-post"><span>🦉</span><div><small>THE GOTHIC OWL GUESTBOOK</small><h2>哥特猫头鹰留言墙</h2><p>选择一枚魔法署名，把想说的话封进只属于当前浏览器的信笺。</p></div><i>前往留言墙　→</i></Link>
