...
export default function HomePage() {
  ...
  return <div className="home-page">
    ...
    <Link href="/owl-post" className="home-owl-post"><span>🦉</span><div><small>THE OWL POST BETWEEN TWO SOULS</small><h2>双人魔法邮局</h2><p>把一封只写给彼此的信，交给穿过星夜的猫头鹰。</p></div><i>前往邮局　→</i></Link>
