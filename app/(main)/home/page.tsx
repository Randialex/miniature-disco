...
export default function HomePage() {
  ...
  return <div className="home-page">
    ...
    <TodayChamber />
    <Link href="/owl-post" className="home-owl-post"><span>🦉</span><div><small>NOCTUA POST · LETTERS AFTER MIDNIGHT</small><h2>夜枭来信</h2><p>把未说完的话，投进会记得你的夜色里。</p></div><i>前往夜枭邮局　→</i></Link>
