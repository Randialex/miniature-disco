...
export default function CpPage() {
  ...
  return <section className="collection-page collection-page--cp">
    <header className="collection-header">
      ...
      <h1 onDoubleClick={() => setEditing(true)} title="双击管理羁绊">羁　绊</h1><p>两颗星相互牵引，从此改变彼此故事的轨迹。</p>
      <button className="archive-manage archive-manage--cp" type="button" onClick={() => setEditing(true)}><span aria-hidden="true">✦</span><b>管理羁绊</b><small>新增 · 编辑 · 删除</small></button>
    </header>
