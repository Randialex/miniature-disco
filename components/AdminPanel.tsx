    ...
    <section className="admin-panel" role="dialog" aria-modal="true" aria-label="站长工具面板">
      ...
      <div className="admin-layout">
        ...
        <div className="admin-content">
          ...
          {tab === "about" ? <section className="about-site"><span className="about-crest">SR</span><h3>{SITE_NAME}</h3><dl><div><dt>版本号</dt><dd>{SITE_VERSION}</dd></div><div><dt>站长</dt><dd>拾染randi</dd></div><div><dt>数据层</dt><dd>本地优先 · Supabase 迁移中</dd></div></dl><small>云端迁移完成前，本地浏览器仍是主要数据来源</small></section> : null}
