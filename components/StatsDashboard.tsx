...
export default function StatsDashboard() {
  ...
  const stats = useMemo(() => {
    ...
    return { average, annualBooks, annualFilms, top: annual.sort((a, b) => b.rating - a.rating || b.date.localeCompare(a.date)).slice(0, 3), bookGenres: genreEntries(books), filmGenres: genreEntries(films), months, max };
